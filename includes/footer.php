			...
			<div class="row">
				...
				<div class="col colStyle">
					...
					<ul class="list-group list-group-flush">
						...
						<a href="#" style="text-decoration:none"><li class="list-group-item">Livraison</li></a>
				...
				<div class="col colStyle">
					...
					<ul class="list-group list-group-flush">
						...
						<a href="tel:+33 1 44 39 06 00" style="text-decoration:none"><li class="list-group-item"><i class="fas fa-phone-alt"></i>&nbsp;+33 1 44 39 06 00</li></a>
						<a href="mailto:votreadresse@mail.fr" style="text-decoration:none"><li class="list-group-item" ><i class="fas fa-envelope"></i>&nbsp;ECE.marketplace@ece.fr</li></a>
					</ul>
				</div>
