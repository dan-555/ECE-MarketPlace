...
<body>
	<div class="container-fluid">
		...
		<h2>Vendeur Client &nbsp;<i class="fa fa-gavel" aria-hidden="true"></i></h2>
		<div class="container">
			<div class="space"></div>
			<div class="d-flex flex-wrap">
				...
				<?php
								$sql = "SELECT idItem, Nom, Prix, Photos from item WHERE commande_idCommande is NULL and categorieachat_CategorieAchat='Transaction Vendeur-Client'";
